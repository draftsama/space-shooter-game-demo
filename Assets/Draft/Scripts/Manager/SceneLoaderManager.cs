...
public class SceneLoaderManager : Singleton<SceneLoaderManager>
{
   ...
   private bool _IsLoading = false;
    ...
    {
        m_CanvasGroup.LerpAlpha(1000, GlobalConstant.ALPHA_VALUE_VISIBLE, _onComplete: () =>
        {
            Observable.FromCoroutine( ()=>SceneLoading(_sceneName)).Subscribe(_ =>
            {
                m_CanvasGroup.LerpAlpha(1000, GlobalConstant.ALPHA_VALUE_INVISIBLE, _onComplete: () =>
                {
                    _IsLoading = false;
